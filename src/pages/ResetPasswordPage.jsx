    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md bg-white p-8 rounded-lg shadow-sm border border-gray-100">
        ...
        <div className="text-center mb-8">
          <h2 className="text-2xl font-bold text-[#D9176C] mb-2">Create new password!</h2>
        ...
        <form onSubmit={formik.handleSubmit} className="flex flex-col gap-6">
          ...
          <button
            type="submit"
            className="bg-[#D9176C] text-white py-3 rounded-md font-bold hover:bg-[#c21560] transition shadow-md mt-2"
          >
            Reset password
          </button>
